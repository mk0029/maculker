          ...
          <div className="d-flex justify-content-between align-items-center pt-sm-4 pt-3">
            ...
            <ul className="mb-0 p-0 d-flex gap-4 ms-xl-5 d-none d-lg-flex">
              ...
              <li>
                <Link
                  to="/About"
                  className={`cursor_block ff_jakarta fw-normal nav_tab_on fs_md text-white position-relative opacity_07 transition px-1 ${props.acTive2}`}>
                  About
                </Link>
              </li>
              <li>
                <Link
                  to="/Testimonials"
                  className={` cursor_block ff_jakarta fw-normal nav_tab_on fs_md text-white position-relative opacity_07 transition px-1 ${props.acTive3}`}
                  href="#">
                  Testimonials
                </Link>
              </li>
              <li>
                <a
                  className=" cursor_block ff_jakarta fw-normal nav_tab_on fs_md text-white position-relative opacity_07 transition px-1"
                  href="#">
                  Location
                </a>
              </li>
            ...
            <ul className="cursor_block d-flex gap-1 mb-0 p-0 mb-0 d-none d-lg-flex">
